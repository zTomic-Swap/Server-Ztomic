 ...
 */
export declare function bigIntToHexadecimal(n: bigint): string;
/**
 ...
 */
export declare function beHexadecimalToBigInt(hex: string): bigint;
/**
 * Converts a hexadecimal string to a bigint. Alias for beHexadecimalToBigInt.
 * @param hex The hexadecimal string to convert.
 * @returns The bigint representation of the hexadecimal string.
 */
export declare function hexadecimalToBigInt(hex: string): bigint;
/**
 ...
 */
export declare function beBufferToBigInt(b: Buffer): bigint;
/**
 ...
 * @returns The bigint representation of the buffer's contents.
 */
export declare function bufferToBigInt(b: Buffer): bigint;
/**
 ...
 */
export declare function beBigIntToBuffer(n: bigint, size?: number): Buffer;
/**
 * Converts a bigint to a buffer and fills with zeros if a valid
 * size (i.e. number of bytes) is specified. If the size is not defined,
 * it gets the size from the given bigint. If the specified size is smaller than
 ...
 */
export declare function leBigIntToBuffer(n: bigint, size?: number): Buffer;
/**
 * Converts a bigint to a buffer. Alias for beBigIntToBuffer.
 * @param n The bigint to convert.
 * @returns The buffer representation of the bigint.
 */
export declare function bigIntToBuffer(n: bigint): Buffer;
/**
 ...
 */
export declare function bigNumberishToBigInt(n: BigNumberish): bigint;
/**
 ...
 */
export declare function bigNumberishToBuffer(n: BigNumberish): Buffer;
/**
